...
class SecondRest extends StatefulWidget {
  const SecondRest({super.key});

  @override
  State<SecondRest> createState() => _SecondRestState();
}

class _SecondRestState extends State<SecondRest> with TickerProviderStateMixin {
