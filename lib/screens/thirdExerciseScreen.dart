...
class ThirdExerciseScreen extends StatefulWidget {
  const ThirdExerciseScreen({super.key});

  @override
  State<ThirdExerciseScreen> createState() => _ThirdExerciseScreenState();
}

class _ThirdExerciseScreenState extends State<ThirdExerciseScreen> {
