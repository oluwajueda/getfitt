...
class ThirdRest extends StatefulWidget {
  const ThirdRest({super.key});

  @override
  State<ThirdRest> createState() => _ThirdRestState();
}

class _ThirdRestState extends State<ThirdRest> with TickerProviderStateMixin {
